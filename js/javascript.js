...
function currentWeather() {
    ...
    var queryURL = "http://api.openweathermap.org/data/2.5/weather?q=" + searchValue + "&appid=30e922552c21f651e398ab194a1b1c83&units=imperial";
...
function forecast() {
    ...
    var searchValue = $("input").val().trim()
    var queryURL = "http://api.openweathermap.org/data/2.5/forecast?q=" + searchValue + "&appid=30e922552c21f651e398ab194a1b1c83&units=imperial"
